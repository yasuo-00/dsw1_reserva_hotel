	...
	<body>
		...
		<div align="center">
			...
			<h2>
				...
				<c:if
					test="${sessionScope.loggedUser!=null && sessionScope.loggedUser.bookingSiteUrl == null && sessionScope.loggedUser.hotelCnpj == null}">
				&nbsp;&nbsp;&nbsp;
			    <a
						href="${pageContext.request.contextPath}/account/admin/adminMenu.jsp">
						<fmt:message key="go_back" />
					</a>
					<br />
				</c:if>
				<br /> <br />
				<c:if
					test="${sessionScope.loggedUser.bookingSiteUrl == null && sessionScope.loggedUser.hotelCnpj == null && sessionScope.loggedUser.email != null}">
